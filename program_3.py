...
import random
state_names= capital_dic={           #dictionary of states and their capitals pull from the internet
    'Alabama': 'Montgomery',
    'Alaska': 'Juneau',
    'Arizona':'Phoenix',
...
def states_dictionary():
    random_state = random.choice(list(state_names.items()))
    answer = input(f"What is the capital of {random_state[0]}?: ")
    if answer  in random_state:
